...
pills_population <- county_median_income %>%
...
ggplot(pills_population) +
  ...
  geom_text(aes(estimate, pills_per_person, label=buyer_county))

```



Since Puerto Rico had the lowest median household income, we will zoom in on that data and plot it. 
